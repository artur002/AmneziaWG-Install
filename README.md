...
```bash
curl -O https://github.com/artur002/AmneziaWG-Install/raw/main/amneziawg-install.sh
```
```bash
wget https://github.com/artur002/AmneziaWG-Install/raw/main/amneziawg-install.sh
```
